...
class _InputFormState extends State<LoginForm> {
  ...
  void login() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final user = await apiService.checkLogin(usernameController.text, passwordController.text);
        ...
        setState(() {
          ...
          // ปิดโหลดดิ้ง
          Navigator.pop(context);
          Navigator.pushNamedAndRemoveUntil(context, custom_route.Routes.home, (route) => false);
        });
