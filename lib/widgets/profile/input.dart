...
//   }
            ...
            builder: (context, state) {
              return Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: state.themeApp ? Colors.red.shade900 : Colors.red.shade300,
                  ...
                  ElevatedButton.icon(
                    icon: const Icon(Icons.save, color: Colors.white, size: 25),
                    onPressed: null, //() => changePassword(context)
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))), label: const Text('บันทึกรหัสผ่าน',style: TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.bold),),),
                ],
              );
            },  
          )
  ...
  Widget buildTextFormField(String hintText, TextEditingController controller, FocusNode focusNode, bool themeApp) {
    return TextFormField(
      style: TextStyle(color: themeApp? Colors.white70 : Colors.white70),
      decoration: InputDecoration(
        hintText: hintText,
        hintStyle: TextStyle(color: themeApp? Colors.white70 : Colors.white70),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(20)),
        suffixIcon: GestureDetector(onTap: () => togglePassword(confirmPasswrodNode), child: isShowPass ? Icon(Icons.visibility, color: themeApp? Colors.white70 : Colors.white70) : Icon(Icons.visibility_off, color: themeApp? Colors.white70 : Colors.black)),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: Colors.orange.shade200)),
      ),
