...
import 'package:calories_buddy/widgets/utils/snackbar.dart';
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: buttonColor1)),
            ),
            ...
            children: [ 
              GestureDetector(
                ...
                child: Container(
                  width: 150,
                  height: 50,
                  decoration: BoxDecoration(color: elementColor, borderRadius: BorderRadius.circular(20), boxShadow: [BoxShadow(color: Color.fromRGBO(181, 181, 181, 0.5), blurRadius: 4, offset: Offset(4, 8))]),
